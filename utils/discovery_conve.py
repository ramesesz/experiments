...
def discover_facts(X, model, top_n=10, strategy='random_uniform', max_candidates=100, target_rel=None, seed=0):
    ...
    for enum, relation in enumerate(rel_list):
        # print('ITERATION : ' + str(enum))
